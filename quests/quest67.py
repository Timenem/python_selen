...
If you move again it will be (0, 2). If your next step is to the left then your position will become (-1, 2). After the next two steps forward your coordinates will be (-1, 4)
...
def follow(instructions: str)->Tuple[int,int]:
    ...
    for i in instructions :
        ...
        if i =='r':
            left_right +=1
        answer = [left_right,forward_back]
    return tuple(answer)        
